//package com.hehe.demo.test1.social;
//
...
//
//    public CustomSocialAuthenticationFilter(AuthenticationManager authManager, UserIdSource userIdSource, UsersConnectionRepository usersConnectionRepository, SocialAuthenticationServiceLocator authServiceLocator) {
...
//
//        SocialAuthenticationToken token = null;
//        String openId=request.getHeader("OpenId");
//        String accessToken=request.getHeader("AccessToken");
//        if (openId!=null||accessToken!=null){
//            if (openId!=null&&accessToken!=null){
//                if (authService instanceof OAuth2AuthenticationService){
//                    //使用三方access_token得到三方用户信息，然后和传入的openId进行校验
//                    AccessGrant accessGrant = new AccessGrant(accessToken);
//                    Connection<?> connection = ((OAuth2AuthenticationService<?>)authService).getConnectionFactory().createConnection(accessGrant);
//                    if (connection.getKey().getProviderUserId().equals(openId)){
//                        //传入的token得到的openId和传入的openId信息不一致
//                        token= new SocialAuthenticationToken(connection, null);
//                    }
//                }
//            }
//            log.info("login for social: OpenId:{},AccessToken:{},url:{}", openId, accessToken,request.getRequestURI());
//        } else {
//            //框架生成token
//            token = authService.getAuthToken(request, response);
//        }
//        if(token == null) {
//            return null;
//        }
